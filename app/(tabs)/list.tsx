...
export default function ListScreen() {
    ...
    const finalItems = filteredByCar.filter(item =>
    ...
    const renderItem = ({ item }: any) => (
        <View style={styles.itemContainer}>
            ...
            <View style={styles.iconRow}>
                {/* Edit icon - we'll implement later */}
        ...
        <View style={styles.container}>
            ...
            <View style={styles.filterContainer}>
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.filterScroll}>
                    ...
                    >
                        <Text style={selectedCarFilter === null ? styles.selectedFilterText : styles.filterText}>
                            All Cars
                        </Text>
                    </TouchableOpacity>
                    {availableCars.map(car => (
                        ...
                        >
                            <Text style={selectedCarFilter === car ? styles.selectedFilterText : styles.filterText}>
                                {car}
                            </Text>
                        </TouchableOpacity>
                    ))}
            ...
            <FlatList
                ...
                ListEmptyComponent={
                    <Text style={styles.emptyText}>
                        {selectedCarFilter ? `No items for ${selectedCarFilter}` : 'No items saved yet'}
                    </Text>
                }
            />
        </View>
...
const styles = StyleSheet.create({
    ...
    savedItem: { backgroundColor: '#fff', padding: 5, borderRadius: 8, flexDirection: 'row' },
