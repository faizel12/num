...
//       }}
//     >
//       {/* These screens are needed for the router to know they exist */}
//       <Drawer.Screen
//         name="(tabs)"
//         options={{
//           drawerLabel: "Home",
...
export default function Layout() {
  return (
    ...
    >
      ...
      <Drawer.Screen name="5l" options={{ title: "5L Cars" }} />
      <Drawer.Screen name="3l" options={{ title: "3L Cars" }} />
      <Drawer.Screen name="2l" options={{ title: "2L Cars" }} />
      <Drawer.Screen name="dolphin" options={{ title: "Dolphin Cars" }} />
      <Drawer.Screen name="abadula" options={{ title: "Abadula Cars" }} />
      <Drawer.Screen name="other" options={{ title: "Other Cars" }} />
